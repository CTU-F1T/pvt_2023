...
def generate_launch_description():
    ...
    cartographer_node = Node(
        ...
        arguments=[
            ...
            'localization.lua',
            '-load_state_filename',
            LaunchConfiguration(variable_name='map'),
        ],
        remappings=[
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            name='map',
            description='Map file name (incl. ext). Can be a relative path (with respect to storage/stage/world) or an absolute path.',
        ),
